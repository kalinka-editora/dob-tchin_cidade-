...
\begin{vplace}[1]
\begin{center}
{\MyriadPro\small{Publicado com o apoio do\\Instituto de Tradução (Rússia)}}
...
\begin{flushleft}
\vspace*{-1.5cm}
{\footnotesize\MyriadPro{Contos russos modernos (1900-1930)}}
\end{flushleft}
\vfill
%\newpage
...
\textbf{A Cidade Ene}\\
\smallskip
{\normalsize Leonid Dobýtchin}\\
{\scriptsize{\slsc{Леонид Добычин}}}
}
\bigbreak
\bigbreak
\bigbreak
...
{\footnotesize\MyriadPro{
Tradução do russo \textbf{Moissei Mountian}\\
\smallskip
Prefácio \textbf{Valéri Sájin}\\
\smallskip
Capa e ilustrações \textbf{Karina Aoki}\\
%Coordenação \textbf{Daniela Mountian}
}}
%\begin{vplace}[2]
%\begin{center}
%\MyriadPro
...
%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{\logo}\hfill\logoum{}\\ São Paulo\_\the\year}}\includegraphics[width=2cm]{./logo_hedra.jpg}\hspace{.5cm}\includegraphics[width=2.2cm]{./LOGOTIPO_KALINKA.jpg}%{\includegraphics[width=3cm]{logos.pdf}}%\break{} Rio de Janeiro\_\the\year}
\end{flushleft}
%\end{vplace}
...
\centering\tiny\noindent{}Este livro foi impresso pela primeira vez em maio de 2020 em papel Pólen Soft 80g. Tipologia: Adobe Devanagari. \begin{center}\normalsize\adforn{64}\end{center}
\end{minipage}
\end{center}
}
