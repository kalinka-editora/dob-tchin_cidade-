...
recebeu o prêmio “{\slsc{Internacional Book of the Year}}” do {\slsc{Times
...
Petersburgo, {\slsc{Akademítcheskii Proiekt}}, 1997–2001) e várias
coletâneas de suas obras; uma coletânea de poemas de B. Ch. Okudjava
(série Biblioteca do Poeta, São Petersburgo, {\slsc{Akademítcheskii
Proiekt}}, 2001); as {\slsc{Obras completas de I. S. Barkóv}} (série
Biblioteca do Poeta, São Petersburgo, {\slsc{Akademítcheskii Proiekt}},
...
dois tomos (Moscou, {\slsc{Nóvoie Literatúrnoie Obozriénie}}, 2012); e em
...
de arte da revista {\slsc{Casa Vogue}} (Edições Globo Condé Nast) por seis anos e
...
A versão se baseou no livro {\slsc{Leonid Dobýtchin: zabýtaia kniga}} (Moscou: {\slsc{Khudójestvennaia literatura}}, 1989). A citação da 4ª capa de Víktor Eroféiev foi retirada do prefácio dessa antologia.\\[6pt]	
%\\[20pt]
\end{center}
