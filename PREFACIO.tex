...
\pagebreak
\begin{center}
{\MyriadPro{\large\textbf{Prefácio\\Livro fatídico}}}
\end{center}
\label{prefacio}
...
almanaque para o qual ele tinha sido convidado a participar. ``(...) se
...
lado a cobradora está de pé em cima de um banco (...)''. E assim por
...
(``Konopátchikova'')\footnote{DOBÝTCHIN, Leonid. Konopátchikova.
...
De forma análoga ao que ocorrera na segunda metade do século XIX,
...
sobrevoou Dvinsk pela primeira vez em 1º de junho de 1911... No
...
impossível em uma narrativa com episódios do comecinho do século XX. Com
...
de uma parte da cidade a outra... São elementos reais de Dvinsk, e
nenhum deles, ao que parece, escapou à narrativa de Dobýtchin.\footnote{Aleksandr
  ...
  livro de Dobýtchin (cf.: DOBÝTCHIN, Leonid. \emph{Gorod En.}
...
em suas correspondências)... Pode-se dizer que toda a vida do narrador,
