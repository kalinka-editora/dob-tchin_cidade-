...
dizia ela --- a esposa de engenheiro Karmánov. Uma mulher muito %esposa do engenheiro?
...
amarradas por pavios e uma velhinha de algodão com bagas para a árvore %é velhinha mesmo?
...
--- ``Veja só!'' --- \emph{Assim dizia} --- \emph{maman} leu o título %Assim falou, como o título é mais conhecido no Brasil?
...
rostos. Nesse momento \emph{madmaselle} Gorchkova, aproximando"-me de mim %não seria aproximando-se?
...
um pequeno jardim e através do jardim distinguia"-se o pôr de sol.%seria pôr do sol? p.66
...
se fazia o sinal de cruz com dois dedos.\footnote{Trata"-se de um adepto %sinal da cruz, como é mais usual no português?
...
Não me deixaram ir do lado outro do portão, mas eu também não tinha %não seria melhor do outro lado?
...
cantaram e queimaram barris de pez. Nós lhes demos cerveja para beber e %o que seria pez?
...
barba e fazendo o sinal de cruz, colocou"-se em frente ao ícone. O aluno %sinal da cruz, como é mais usual no português?
...
até seu restabelecimento não pode nem deitar de costas nem sentar. %seria pôde, certo?
...
da ``direita'', mas participava delas com gosto.\footnote{Alusão ao
  apoio de parte da burguesia à revolução russa de 1905.} Ela me contou %revolução russa em c.b. mesmo?
...
assim ele começava e tinha uma assinatura: ``Com a bênção do monge %manter em c.b. esse assim mesmo?
...
estavam listados numa tabuleta pregada no \qb{}portão ---,

``pincéis, verniz e cola'' ---
\end{quotation}

pensativos, íamos cantarolando isso sob acompanhamento do trompete. %pensativos em c.b. mesmo?

Conversando, fomos parar no cemitério. O pôr de sol já se refletia nas %pôr do sol?
...
tempos atrás, vi umas velas penduradas. A velhinha de algodão, tão %velinhas?
...
açucareiro que tinha ganhado na ``\emph{lotereia allegri}''.\footnote{\emph{Lotereia
  alegrii}, forma de loteria em que se sabia instantaneamente se o %allegri ou alegrii?
...
livro \emph{M. Lêrmontov},\footnote{Referência ao poema \emph{O %deixar o nome em itálico, sendo que é o autor e não a obra?
...
\emph{s'assamble}.\footnote{\emph{Qui se ressamble s'assemble}, %manter s'assamble, como na grafia russificada do texto?
...
pensava eu ---, quando eu compreenderei tudo isso, serão os quinze, só %deixar entre aspas, no padrão do "A idade perigosa"?
...
\emph{maman} com uma ``Bíblia''. --- Aqui tem cada coisa! --- disse ela. %não seria o caso de deixar em itálico em vez de parênteses?
...
tinha lido sobre os cristãos da antiguidade. Lamentávamos sermos %antiguidade em c.a.?
...
balcão e gesticulava --- Paulus!\footnote{\emph{So sagt der apostel} %manter esse Paulus em itálico, conforme padrão da nota de rodapé?
...
Todos nós ficamos comovidos. Ele apertava nossas mãos, radiante e andava %achei essa vírgula um pouco estranhas
...
longamente parados numa curva. Nas nuvens de chuvas, refletia"-se o %chuvas mesmo, no plural?
...
--- O senhor leu --- disse ela --- ``Nat Pinkerton e a literatura %não seria melhor itálico para manter padrão?
...
Chúster frequentava a rua Podólskaia. --- Chúster --- repetia eu a mim %suprimir o eu?
