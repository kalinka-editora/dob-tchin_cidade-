...
avistamos o \emph{kostiol}.\footnote{\emph{Kostiol}, do polonês, templo
  católico. Poloneses são, na maioria, católicos.} De telhado vermelho, o templo embranquecia atrás dos
...
--- dizia ela com comoção ---, perdoe"-me.\footnote{Trata"-se provavelmente de uma alusão a uma das várias peças populares que narravam o destino trágico de Aleksandr Púchkin (1799-1837), o poeta nacional que morrera num duelo com o francês Georges Charles d’Anthès (1812-1895), depois deste haver cortejado Natália Gontcharova (1812-1863), esposa de seu rival.}
...
sentou"-se ao lado dela, e elas falaram que era preciso vender a propriedade de
...
outro. Tentando me encorajar, ela tentava agarrar minhas mãos e
...
\emph{s'assamble}.\footnote{\emph{Qui se ressemble s'assemble},
...
balcão --- \emph{Paulus!}\footnote{\emph{So sagt der apostel
  Paulus}, do alemão, ``assim diz o apóstolo Paulo'' (russificado
...
visitaria a livraria ``\emph{Oświata}''\footnote{\emph{Oświata}, do
  ...
  \emph{księgarnia}, ``livraria'').} para fazer uma assinatura de meio
