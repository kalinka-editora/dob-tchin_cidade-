...
\pagebreak
\begin{center}
{\MyriadPro{\large\textbf{Prefácio}}}
\end{center}
\label{prefacio}
...
Tchítchikov.\footnote{Tchítchikov, personagem principal de \emph{Almas
  mortas} (1842)\emph{,} de Nikolai Gógol (1809--1852).} Nos portões
...
O pai saiu para a repartição onde recebiam os recrutas. \emph{Мamаn},
...
Léikin...\footnote{Nikolai Léikin (1841--1906), escritor humorista
  russo. Editou a revista de humor \emph{Oskólki} (1881-1916)\emph{,} em
...
Kágan, а agenciadora, enviou-nos uma nova babá. Ela era uniata\footnote{Uniata
...
Os Belúguin foram transferidos para Mitava.\footnote{Мitava ou Elgava,
...
\emph{kringels}.\footnote{\emph{Kringel}, rosca nórdica, variedade de
  \emph{pretzel} (\emph{bretzel})\emph{.}} Numa noite um senhor que
...
entregar \emph{As notícias} \emph{da bolsa}. \emph{Мaman} verificava o
...
А escola era marrom e a fachada, dividida em gomos por ranhuras,
...
conselheiros Piótr Petróvitch Schúkin e Sófia Grigórievna Schúkinа''. Eu
...
Pouco depois Kondrátievа apareceu em casa e nos convidou para comemorar
...
Na primeira semana da quaresma nossa escola jejuou. \emph{Мamаn} me
...
se fazia o sinal de cruz com dois dedos.\footnote{Trata-se de um adepto
  ...
  devido às reformas do patriarca Níkon (1645\emph{--}1676) e que fazem
...
Mal chegamos, começaram а nos fazer perguntas. Algo nos fazia lembrar
...
exemplar do \emph{Dvin}á. --- Finalmente а paz! --- gritava ele. Eu lhe
...
``principal'' e Andrei ``na paralela''.\footnote{Conforme K. Pаustóvski,
...
Karamázov,\footnote{Lev Mýchkin e Aleksiei Karamázov, personagens,
  ...
  Karamázov} (1879)\emph{,} romances de Dostoiévski.} e nos
conhecêssemos?
...
escola. Eu ouviа o ruído dos passantes no bulevar. Admirava a faixa do
...
chamava-se \emph{Então, o que fazer?}.\footnote{\emph{Então, o que
  fazer?} (\emph{Tak tcho je nam dielat?,} 1886)\emph{,} obra não
